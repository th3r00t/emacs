...
#+begin_src emacs-lisp :tangle no
  ...
  (global-set-key (kbd "A-j") 'enlarge-window)
  (global-set-key (kbd "A-k") 'shrink-window)
  (global-set-key (kbd "A-h") 'enlarge-window-horizontally)
  (global-set-key (kbd "A-l") 'shrink-window-horizontally)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'dap-cpptools
    ...
    (dap-register-debug-template "Rust::Bog"
                                 (list :type "cppdbg"
                                       :request "launch"
                                       :name "Rust::Bog"
                                       :MIMode "gdb"
                                       :miDebuggerPath "rust-gdb"
                                       :environment []
                                       :program "/home/th3r00t/.local/builds/bog/target/debug/bog"
                                       :cwd "/home/th3r00t/.local/builds/bog"
                                       :console "external"
                                       :dap-compilation "cargo build"
                                       :dap-compilation-dir "/home/th3r00t/.local/builds/bog"))
...
*** Flycheck
#+begin_src emacs-lisp
  (use-package flycheck :ensure t :init (global-flycheck-mode nil))
#+end_src
*** VDiff
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (defun t3/linum-hook ()
    (linum-mode 1))
  (add-hook 'prog-mode-hook 't3/linum-hook)
#+end_src
** LSP Mode Hooks
#+begin_src emacs-lisp
  (defun t3/lsp-mode-hook ()
    ...
    (setq lsp-enable-signature-help t)
  ...
  (add-hook 'lsp-mode-hook 't3/lsp-mode-hook)
#+end_src
** Org Mode Hooks
#+begin_src emacs-lisp
